...
<x-guest-layout>
    <div class="fixed inset-0 min-h-screen w-full flex items-center justify-center bg-gradient-to-tr from-white via-blue-100 to-blue-300">
        ...
        <div class="w-1/2 flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-tl-[200px] rounded-bl-[200px] shadow-lg w-[950px] h-[865px] p-20 relative"
                    data-aos="fade-left"
                    data-aos-duration="1000">
                <div class="absolute top-[140px] left-0 w-full text-3xl font-bold text-center font-[Carena] z-10">
                    Log In
                </div>
                <!-- Session Status -->
