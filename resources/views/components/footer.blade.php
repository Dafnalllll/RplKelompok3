    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6">
        ...
        <div class="flex gap-4 mt-4 md:mt-0">
            <a href="https://instagram.com/andalaswheels" target="_blank" aria-label="Instagram">
                <i class="fa-brands fa-instagram text-xl hover:text-yellow-400 transition"></i>
            </a>
            <a href="mailto:info@andalaswheels.com" aria-label="Email">
                <i class="fa-solid fa-envelope text-xl hover:text-yellow-400 transition"></i>
            </a>
            <a href="#" aria-label="WhatsApp">
                <i class="fa-brands fa-whatsapp text-xl hover:text-yellow-400 transition"></i>
            </a>
        </div>
    </div>
</footer>
